 ...
 * possibles (pas de pages faibles ou redondantes).
 */
...
export const METRICS: Metric[] = [
  ...
  { key: "acc", label: "0 à 100 km/h", group: "Performances", type: "specialized", value: (v) => v.acceleration0to100, format: (v) => fmt(v.acceleration0to100, "s", 1), best: "min", highlight: "Meilleur temps 0 à 100 km/h" },
  ...
  { key: "len", label: "Longueur", group: "Dimensions", type: "specialized", value: (v) => v.dimensions.length, format: (v) => fmt(v.dimensions.length, "mm") },
